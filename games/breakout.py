...
class Breakout():
    def main(self):
        ...
        bat = pygame.image.load("media/bat.png").convert()
        batrect = bat.get_rect()

        ball = pygame.image.load("media/ball.png").convert()
        ball.set_colorkey((255, 255, 255))
        ballrect = ball.get_rect()

        pong = pygame.mixer.Sound('media/blip.wav')
        pong.set_volume(10)
        ...
        while 1:
            ...
            if ballrect.top > height:
                ...
                if lives == 0:
                    msg = pygame.font.Font(None, 70).render("Game Over", True,
                                                            (0, 255, 255), bgcolour)
...
class Wall():
    def __init__(self):
        self.brick = pygame.image.load("media/brick.png").convert()
